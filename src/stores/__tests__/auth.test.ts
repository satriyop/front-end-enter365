...
describe('auth logout', () => {
  ...
  it('hard-navigates cashiers to /kasir after login so leftover dialog locks cannot survive', async () => {
    ...
    await store.login({ email: 'siti@kopitiam57.test', password: 'WRGKvh-WU#pL5ii#mufZXxpW' })
  ...
  it('hard-navigates accountants to journal entries after the token is stored', async () => {
    ...
    await store.login({ email: 'rina@kopitiam57.test', password: 'WRGKvh-WU#pL5ii#mufZXxpW' })
  ...
  it('hard-navigates gudang to /inventory after the token is stored', async () => {
    ...
    await store.login({ email: 'dewi@kopitiam57.test', password: 'WRGKvh-WU#pL5ii#mufZXxpW' })
  ...
  it('hard-navigates owner/admin to the dashboard', async () => {
    ...
    await store.login({ email: 'admin@example.com', password: 'WRGKvh-WU#pL5ii#mufZXxpW' })
