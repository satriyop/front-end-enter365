...
export const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Analytic Plans', path: '/accounting/analytic-plans', icon: '🗂️', permission: 'journals.view' },
      { name: 'Analytic Distribution Models', path: '/accounting/analytic-distribution-models', icon: '➗', permission: 'journals.view' },
      { name: 'Analytic Items', path: '/accounting/analytic-items', icon: '📑', permission: 'journals.view' },
      { name: 'Analytic Budgets', path: '/accounting/analytic-budgets', icon: '🧮', permission: 'journals.view' },
      { name: 'Taxes', path: '/accounting/tax-records', icon: '🧾', permission: 'journals.view' },
      { name: 'Tax Tags', path: '/accounting/tax-tags', icon: '🏷️', permission: 'journals.view' },
      { name: 'Payment Terms', path: '/accounting/payment-terms', icon: '💳', permission: 'journals.view' },
      { name: 'Payment Methods', path: '/accounting/payment-methods', icon: '💳', permission: 'journals.view' },
      { name: 'Payment Providers', path: '/accounting/payment-providers', icon: '💳', permission: 'journals.view' },
      { name: 'Checks', path: '/accounting/checks', icon: '💳', permission: 'journals.view' },
      { name: 'Fiscal Positions', path: '/accounting/fiscal-positions', icon: '🗺️', permission: 'journals.view' },
      { name: 'Currencies', path: '/accounting/currencies', icon: '💱', permission: 'journals.view' },
      { name: 'Cash Roundings', path: '/accounting/cash-roundings', icon: '🪙', permission: 'journals.view' },
      { name: 'Multi Ledgers', path: '/accounting/ledgers', icon: '📚', permission: 'journals.view' },
      { name: 'Follow-up Levels', path: '/accounting/follow-up-levels', icon: '⏱️', permission: 'journals.view' },
      { name: 'Employee Expenses', path: '/accounting/employee-expenses', icon: '🧾', permission: 'bills.view' },
      ...
      { name: 'Transfers', path: '/accounting/transfers', icon: '↔️', permission: 'journals.view' },
      { name: 'Journal Entries', path: '/accounting/journal-entries', icon: '📝', permission: 'journals.view' },
      { name: 'Journal Items', path: '/accounting/journal-items', icon: '📋', permission: 'journals.view' },
      { name: 'Journal Audit', path: '/accounting/journal-audit', icon: '🔎', permission: 'journals.view' },
      { name: 'Working Files', path: '/accounting/working-files', icon: '🗂️', permission: 'journals.view' },
      { name: 'Audit Trail', path: '/accounting/audit-trail', icon: '🛡️', permission: 'journals.view' },
      ...
      { name: 'Reconcile', path: '/accounting/reconcile', icon: '🔗', permission: 'journals.view' },
      { name: 'Bill to Receive', path: '/accounting/bill-to-receive', icon: '📥', permission: 'reports.financial' },
      { name: 'Billed Not Received', path: '/accounting/billed-not-received', icon: '📤', permission: 'reports.financial' },
      { name: 'Invoices to Be Issued', path: '/accounting/invoices-to-be-issued', icon: '🧾', permission: 'reports.financial' },
      { name: 'Invoiced Not Delivered', path: '/accounting/invoiced-not-delivered', icon: '🚚', permission: 'reports.financial' },
      { name: 'Tax Returns', path: '/accounting/tax-returns', icon: '🧾', permission: 'reports.tax' },
      { name: 'Unrealized Currencies', path: '/accounting/unrealized-currencies', icon: '💱', permission: 'reports.financial' },
      { name: 'Invoice Analysis', path: '/accounting/invoice-analysis', icon: '📈', permission: 'reports.financial' },
      { name: 'Analytic Report', path: '/accounting/analytic-report', icon: '🎯', permission: 'reports.financial' },
      { name: 'Executive Summary', path: '/accounting/executive-summary', icon: '📋', permission: 'reports.financial' },
      { name: 'Budget Report', path: '/accounting/budget-report', icon: '📊', permission: 'reports.financial' },
...
export const POS_NAV_ID: Record<string, string> = {
  ...
  'Fiscal Positions': 'Posisi Fiskal',
  Assets: 'Aset Tetap',
  'Asset Models': 'Model Aset',
