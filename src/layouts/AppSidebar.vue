                      ...
                      : item.path === '/accounting/loans-analysis'
                        ...
                        : item.path === '/accounting/deferred-expenses'
                          ...
                          : item.path === '/accounting/deferred-revenues'
                            ...
                            : item.path === '/accounting/analytic-plans'
                                                    ...
                                                    : item.path === '/accounting/currencies'
                                                      ...
                                                      : item.path === '/accounting/cash-roundings'
                                                        ...
                                                        : item.path === '/accounting/ledgers'
                                                          ? 'sidebar-ledgers'
                                                          : item.path === '/accounting/follow-up-levels'
                                                            ? 'sidebar-follow-up-levels'
                                                            : item.path === '/accounting/employee-expenses'
                                                              ? 'sidebar-employee-expenses'
