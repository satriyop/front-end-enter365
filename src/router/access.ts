export const PERMISSION_ROUTE_PREFIXES: Array<{ prefix: string; permission: string }> = [
  ...
  { prefix: '/accounting/follow-up-levels/new', permission: 'journals.create' },
  { prefix: '/accounting/follow-up-levels', permission: 'journals.view' },
  { prefix: '/accounting/employee-expenses/new', permission: 'bills.create' },
  { prefix: '/accounting/employee-expenses', permission: 'bills.view' },
  ...
  { prefix: '/projects/my-tasks', permission: 'project_tasks.view' },
  { prefix: '/projects/tasks-analysis', permission: 'reports.project' },
  { prefix: '/projects/customer-ratings/new', permission: 'project_tasks.create' },
  { prefix: '/projects/customer-ratings', permission: 'project_tasks.view' },
  { prefix: '/projects/tasks', permission: 'project_tasks.view' },
