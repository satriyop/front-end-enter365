  ...
  <div>
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-slate-500">Manage solar installation projects</p>
      </div>
    ...
    <div v-else-if="projects.length === 0" class="bg-white rounded-xl border border-slate-200">
      <EmptyState
      ...
      <table class="w-full">
        <thead class="bg-slate-50 border-b border-slate-200">
          <tr>
            ...
            <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Timeline</th>
        ...
        <tbody class="divide-y divide-slate-200">
          <tr v-for="project in projects" :key="project.id" class="hover:bg-slate-50">
            <td class="px-6 py-4">
              <RouterLink :to="`/projects/${project.id}`" class="text-orange-600 hover:text-orange-700 font-medium">
            ...
            <td class="px-6 py-4">
              <div class="flex items-center gap-2">
                ...
                <span class="text-sm text-slate-600">{{ project.progress_percentage ?? 0 }}%</span>
              </div>
            </td>
            <td class="px-6 py-4">
    ...
    <Modal :open="showDeleteModal" title="Delete Project" size="sm" @update:open="showDeleteModal = $event">
      <p class="text-slate-600">Are you sure you want to delete this project?</p>
      <template #footer>
