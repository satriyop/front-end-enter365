...
import { Check, ArrowLeftRight, Loader2 } from 'lucide-vue-next'
import { formatCurrency, formatDate } from '@/utils/format'
import { Button, Badge, Modal, Card, Input, useToast, ResponsiveTable, type ResponsiveColumn } from '@/components/ui'
import { useFeaturesStore } from '@/stores/features'
import BomPanelToolbar from '@/pages/addons/electrical-panel/components/BomPanelToolbar.vue'
        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          ...
          <div class="flex gap-2">
            ...
            <BomPanelToolbar
              ...
              @optimize="openOptimizeModal"
              @compare="openCompareModal"
              @swap-brand="showSwapBrandModal = true"
              @generate-variants="showGenerateVariantsModal = true"
            />
